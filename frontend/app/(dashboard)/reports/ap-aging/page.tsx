...
import { useApAging } from '@/lib/hooks/useReports';
...
export default function ApAgingPage() {
  ...
  return (
    <div className="space-y-6 print:space-y-4">
      ...
      <h1 className="hidden print:block text-2xl font-bold text-center">AP Aging Report</h1>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="flex justify-between items-center border rounded-lg px-4 py-3 bg-muted/20">
            <span className="font-semibold">Total Outstanding AP</span>
              ...
              <TableBody>
                {data.rows?.length ? data.rows.map((r: any, i: number) => (
                  <TableRow key={i}>
                    ...
                    <TableCell className="font-mono text-sm">{r.bill_number ?? '—'}</TableCell>
